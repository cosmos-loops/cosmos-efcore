...
{
    internal class MsSqlRawQueryGenerator : SqlServerQuerySqlGenerator, ISqlRawQueryGenerator
    {
        /// <summary>
        ...
        public MsSqlRawQueryGenerator(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
            : base(dependencies)
        {
