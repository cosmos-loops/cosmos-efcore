...
{
    internal class SqliteRawQueryGenerator : SqliteQuerySqlGenerator, ISqlRawQueryGenerator
    {
        /// <summary>
        ...
        public SqliteRawQueryGenerator(QuerySqlGeneratorDependencies dependencies, ISqlGenerationHelper sqlGenerationHelper)
            : base(dependencies)
        {
